;*****************start of the SR_OS kernel code***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to SR_OS version 1.0.0", 0x00

	wel1 db	'***************************************************', 0x00			

	wel2 db '************ WELCOME TO SR_OS *************', 0x00 
	...
	wel7 db ' version 1.0.0 of SR_OS From W.A.S Randika - SE/2019/034', 0x00
	...
	strPrompt		db	"SR_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"SR", 0x00	;OS details
